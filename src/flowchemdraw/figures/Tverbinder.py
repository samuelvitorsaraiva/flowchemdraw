...
class Tverbinder(components):
    ...
    def settup_connections(self):
        ...
        pos = self.position
        self.connection_points = {1: {'name': None, 'pairs': [2, 3], 'position': (pos[0] + r/20, pos[1] + r/2)},
                                  2: {'name': None, 'pairs': [1, 3], 'position': (pos[0] + r/20, pos[1] - r/2)},
                                  3: {'name': None, 'pairs': [1, 2], 'position': (pos[0] + r/1.5, pos[1] + r / 20)}}
